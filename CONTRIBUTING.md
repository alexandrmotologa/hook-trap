# Contributing to Hook-Trap

Thank you for your interest in contributing to Hook-Trap! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/hook-trap.git
   cd hook-trap
   ```
...
Hook-Trap requires **Python 3.12+** and uses [`uv`](https://github.com/astral-sh/uv) (or standard `pip` / `venv`) for reproducible virtual environments.
